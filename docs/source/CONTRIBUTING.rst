...
* (#698) chore: 0.1.0
* (#698) docs: Add configuration setting
* (#698) feat: Create Lambda function
* (#698) fix: Retry upload on failure
* (#698) refactor: Extract duplicate code
* (#698) style: isort, YAPF
* (#698) test: Coverage around add permissions
...
.. _Issue: https://github.com/luismayta/react-redux-items/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc
.. _Pull Request: https://github.com/luismayta/react-redux-items/pull-requests/
