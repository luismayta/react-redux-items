...
<!-- Title: Contributing GitFlow ReactReduxItems -->
...
To contribute to react-redux-items project on [GitHub](https://github.com/luismayta/react-redux-items), We use Gitflow (See more [here](https://datasift.github.io/gitflow/IntroducingGitFlow.html)) In a nutshell, it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/luismayta/react-redux-items/pulls).

![workflow gitflow](https://datasift.github.io/gitflow/GitFlowHotfixBranch.png)

## Getting started

To follow the instructions in this guide and start contributing to react-redux-items project on Gitlab:
...
```bash
git remote add upstream  https://github.com/luismayta/react-redux-items.git
```

Now your **upstream** points to **luismayta/react-redux-items**.
...
git fetch upstream # assuming upstream is luismayta/react-redux-items
...
All merge requests are automatically tested using [Github Actions](https://github.com/luismayta/react-redux-items/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
