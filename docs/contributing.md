...
<!-- Title: Contributing ReactReduxItems -->
...
Contributions to react-redux-items are welcome.

Feel free to use all of the contribution options:

- Contribute to react-redux-items repositories on [GitHub](https://github.com/luismayta/react-redux-items). See [Git flow](./contribute/git-flow.md).
...
Documentation is a part of the react-redux-items code base. You can find the documentation files in the `doc/` subdirectory of the [main repository](https://github.com/luismayta/react-redux-items). This means that the contribution process is the same for both the source code and documentation.
...
1.  See if a [Pull Request](https://github.com/luismayta/react-redux-items/pulls) exists
    - Add some comments or review the code to help it along
    - Don\'t be afraid to comment when logic needs clarification
2.  Create a Fork and open a [Pull Request](https://github.com/luismayta/react-redux-items/pulls) if needed

### Code Review

- Anyone can review code
- Any [Pull Request](https://github.com/luismayta/react-redux-items/pulls) should be closed or merged within a week
